...
import { openWeblink } from "../utils/helpers";
  ...
  render() {
    return (
      <ul className="platforms">
        <li
          className="platforms__item pointer"
          onClick={() =>
        ...
        <li
          className="platforms__item pointer"
          onClick={() => openWeblink("https://github.com/jerhardt1")}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="32"
        ...
        <li
          className="platforms__item pointer"
          onClick={() =>
            openWeblink("https://www.linkedin.com/in/johann-erhardt-022775178/")
          }
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <li
          className="platforms__item pointer"
          onClick={() => openWeblink("mailto:johannerhardt4@gmail.com")}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="32"
